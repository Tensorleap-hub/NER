...
def _connect_to_gcs_and_return_bucket(bucket_name: str) -> Bucket:
    ...
    gcs_client = storage.Client(project=CONFIG['gcs_project'], credentials=credentials)
...
def _download(cloud_file_path: str, local_file_path: Optional[str] = None) -> str:
    ...
    if local_file_path is None:
        ...
        local_file_path = os.path.join(home_dir, "Tensorleap", CONFIG['gcs_bucket_name'], cloud_file_path)
